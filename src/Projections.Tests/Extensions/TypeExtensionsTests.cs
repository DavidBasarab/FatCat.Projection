...
public class TypeExtensionsTests
{
	...
	public void IsBasicType(Type typeToTest, bool isBasic) { typeToTest.IsBasicType().Should().Be(isBasic); }

	[Theory]
	[InlineData(typeof(List<SourceItemsWithStuff>))]
	public void IsList(Type typeToCheck) { typeToCheck.IsList().Should().BeTrue(); }
}