...
public class CustomProjectionConfigurationTests
{
    ...
    {
        ProjectionConfiguration.UseCustomProjection<NonStronglyTypedProjection>(
            typeof(NonStronglyTypeDestination)
        );
        ...
        projector.Should().BeOfType<NonStronglyTypedProjection>();
    }
    ...
    {
        ProjectionConfiguration.GetCustomProjector<NeverGetConfiguredDestination>().Should().BeNull();
    }
    ...
    private static void RunGetCustomerProjectorTest<T>()
        where T : IDoProjection<ConfigTestDestination>
    {
        var customProjector = ProjectionConfiguration.GetCustomProjector<ConfigTestDestination>();

        customProjector.Should().NotBeNull();

        customProjector.Should().BeOfType<T>();
    }
    ...
    {
        public void Project(ConfigTestDestination destinationObject, object source)
        {
            throw new NotImplementedException();
        }
        ...
        public ConfigTestDestination ProjectTo(object source)
        {
            throw new NotImplementedException();
        }
